...
export const LisSkills: React.FC<SkillsProps> = ({lisSkills, list}) => {
  return (
    <div className='flex flex-col items-center gap-16 2xl:gap-8 lg:gap-3 md:gap-3 gap-0'>
        <h3 className='3xl:text-h3 2xl:text-h3-md xl:text-h3-md lg:text-h3-sm'>{list}</h3>
        <div className='relative 3xl:w-[500px] 3xl:h-[500px] 2xl:w-[380px] 2xl:h-[380px] xl:w-[350px] xl:h-[380px] lg:w-[320px] lg:h-[350px] 
                      md:w-[300px] md:h-[300px] w-[400px] h-[400px]'>
            ...
            <div className='absolute bg-secondary  md:top-[40px] md:left-[40px] rounded-full 
              ...
              w-[250px] h-[250px] blur-[120px] top-[80px] left-[80px]
            '></div>
        </div>
    </div>
  )
