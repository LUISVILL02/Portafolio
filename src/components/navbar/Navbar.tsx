...
export const Navbar = () => {
  ...
  return (
    <>
      <header className="h-[120px] mb-40 max-2xl:h-[100px] max-2xl:mb-32">
          ...
          >
            <p className=" flex items-center gap-2 text-button max-2xl:text-h2-xs justify-center cursor-pointer"
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            >
              <HomeIcon/> {scroll ? '' : 'Inicio'}
            </p>
            <ul className={`flex gap-10 ${scroll ? 'flex-col gap-5 P-5 items-center' : 'max-2xl:gap-3'}`}>
