...
export const Icon = (prop: {className?: string}) => {
  return (
    <svg width="398" height="375" viewBox="0 0 398 375" fill="none" xmlns="http://www.w3.org/2000/svg" className={prop.className}>
        <circle cx="177" cy="197" r="140" fill="#787878"/>
        <path d="M194.073 342.667C186.5 356.6 166.5 356.6 158.928 342.667L39.7065 123.3C32.4637 109.974 42.1112 93.75 57.279 93.75L295.721 93.75C310.889 93.75 320.536 109.974 313.294 123.3L194.073 342.667Z" fill="url(#paint0_linear_373_100)"/>
