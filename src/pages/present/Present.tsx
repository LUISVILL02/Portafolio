...
export const Present = () => {
  return (
    <section id="Home" className="animate-show animate-hide flex gap-[100px] w-[94%] justify-between relative">
        <div className="w-[49%]">
          <h3 className="text-h3">¡Hola! Soy!</h3>
          <h2 className="text-h2 text-primary animate-typing">LUISVILL</h2>
