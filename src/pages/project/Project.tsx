  ...
  return (
      <section
        ...
        <div className='flex flex-row items-center gap-[18px]'>
          <ProjectIcon className='3xl:w-[93px] 3xl:h-[96px] 2xl:w-[50px] 2xl:h-[50px] xl:w-[45px] xl:h-[45px]'/>
          <h2 className="3xl:text-h2 2xl:text-h2-2xl xl:text-h2-xl text-primary">PROYECTOS</h2>
        </div>
        <ListProjct/>
      </section>
  )
